//-------- este archivo configura las rutas para que sean accesibles para la aplicacion------------
//-------- MODULO 1:  HISTORIAS CLINICAS ------------
...
const setupCapacitacionRoutes = require('./capacitacion.routes');
const setupAsistenciaRoutes = require('./asistencia.routes');
const setupParticipantenRoutes = require('./participante.route');

const setupFormacionRoutes = require('./formacion.routes');
...
function routerApi(app) {
  ...
  setupComunidadRoutes(router);  //--------- llamar a la funcion que CREA O GENERA LAS RUTAS DEL MODULO COMUNIDAD
  setupCapacitacionRoutes(router); //--------- llamar a la funcion que CREA O GENERA LAS RUTAS DEL MODULO CAPACITACIÓN

  setupAsistenciaRoutes(router);
  setupParticipantenRoutes(router);
  setupFormacionRoutes(router);
}
